...
static int ieee802154_send_beacon_command_frame(struct net_device *netdev, u8 cmd_frame_id)
{
	...
	hlen = 7; //Header is 7 octets from IEEE 802.15.4 std 2011
	tlen = netdev->needed_tailroom;
	size = 1; //Todo; Replace magic number with a define. Comes from ieee std 802154 "Beacon Request Frame Format"
